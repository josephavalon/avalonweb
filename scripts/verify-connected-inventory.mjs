...
const migrations = [83, 84, 85, 86, 87, 88, 89].map((number) => read(`supabase/migrations/0${number}_${[
  ...
  'connected_inventory_catalog_commands', 'connected_inventory_governance',
][number - 83]}.sql`));
