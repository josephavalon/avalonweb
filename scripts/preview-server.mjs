...
const PUBLIC_SPA_ROUTE_PATTERNS = [
  ...
  /^\/(subscription|plan|corporate|hotel|service-area|partners|platform|b2b|custom|book|protocols|menu|checkout|login|signup|forgot|forgot-password|admin\/login|order|redeem)$/,
