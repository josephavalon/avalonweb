...
const replacements = [
  ...
  { from: /<meta name="description" content="[^"]*"/, to: '<meta name="description" content="Pre-buy Avalon race-day recovery for Bay to Breakers 2026 with clinician-reviewed intake, licensed registered nurse staffing, and finish-line support."' },
  { from: /<meta property="og:title" content="[^"]*"/, to: '<meta property="og:title" content="Bay to Breakers Recovery Presale | Avalon Vitality"' },
  { from: /<meta property="og:description" content="[^"]*"/, to: '<meta property="og:description" content="Pre-buy race-day recovery with Avalon. Clinician-reviewed intake, licensed registered nurse staffing, and finish-line support."' },
  ...
  { from: /"image": "https:\/\/www\.avalonvitality\.co\/[^"]+"/, to: '"image": "https://www.avalonvitality.co/og-b2b.png"' },
  ...
  { from: /<meta name="twitter:description" content="[^"]*"/, to: '<meta name="twitter:description" content="Pre-buy race-day recovery with Avalon. Clinician-reviewed intake and licensed registered nurse staffing."' },
...
const b2bPrerender = `
      <div id="seo-prerender" style="min-height:100vh;background:#0a0a0a;color:#f4f4f1;font-family:Inter,Arial,sans-serif;padding:48px 24px;">
        <main style="max-width:960px;margin:0 auto;">
          ...
          <p style="max-width:700px;font-size:18px;line-height:1.65;color:rgba(244,244,241,.68);margin:0 0 34px;">Pre-buy race-day recovery for Bay to Breakers 2026. Avalon coordinates guest intake, clinical review, licensed registered nurse staffing, and finish-line recovery support for eligible participants.</p>
...
const b2bJsonLd = {
  ...
  '@graph': [
    ...
    },
    {
      ...
      description: 'Race-day recovery support for eligible participants with intake, clinical review, and licensed registered nurse staffing.',
    },
  ],
};
