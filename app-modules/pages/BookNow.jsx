...
function StepProgress({ step, onStepSelect }) {
  ...
  return (
    <div className="relative mb-2 overflow-hidden rounded-[1.35rem] border border-foreground/10 bg-background/38 p-2 shadow-[inset_0_1px_0_hsl(var(--foreground)/0.12),0_20px_90px_hsl(var(--foreground)/0.08)] backdrop-blur-2xl md:mb-5 md:rounded-[1.6rem] md:p-2.5">
