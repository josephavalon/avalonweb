  ...
  return (
    <section className="pt-10 pb-10 md:pt-16 md:pb-16 px-5 md:px-12">
      <motion.div
        ...
        className="av-treatment-card relative mx-auto max-w-3xl overflow-hidden rounded-[1.3rem] border px-6 py-10 text-center md:px-10 md:py-14"
      >
        {/* Static Avalon drop mark — grayed-out watermark backdrop. Sits behind
            text, non-interactive, aria-hidden already set on the primitive. */}
        <AvalonMark
          className="pointer-events-none absolute left-1/2 top-1/2 h-56 w-36 -translate-x-1/2 -translate-y-1/2 text-foreground/[0.05] md:h-72 md:w-[186px]"
        />
