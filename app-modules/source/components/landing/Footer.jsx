...
export default function Footer() {
  ...
  return (
    <footer className="px-4 pb-3 pt-5 md:pb-3 md:pt-5">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="hidden md:grid md:grid-cols-4 gap-x-8 gap-y-3 mb-3">
          ...
          <div>
            ...
            <div className="space-y-0">
              ...
              <div className="avalon-footer-link flex min-h-7 items-center gap-2 font-body text-xs leading-tight text-foreground/50">
                <Clock className="w-3.5 h-3.5 shrink-0" />
                8AM-8PM
              </div>
              <div className="avalon-footer-link flex min-h-7 items-center gap-2 font-body text-xs leading-tight text-foreground/50">
