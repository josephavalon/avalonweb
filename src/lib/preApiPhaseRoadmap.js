...
export const PRE_API_PHASE_CLOSURE_CONTROLS = [
  ...
  { phaseId: 'phase-4', label: 'Execution Closure', score: 100, proof: ['Deterministic booking flow', 'readiness blockers', 'transition checks', 'nurse ETA ownership'], residual: 'Acuity status writeback remains API work.' },
