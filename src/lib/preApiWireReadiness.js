...
export const WIRE_TOMORROW_INTEGRATIONS = [
  ...
  },
  {
    id: 'hubspot',
    label: 'HubSpot',
    role: 'Hospitality CRM and lifecycle outreach',
    owns: ['CRM-safe profile', 'lead lifecycle', 'hospitality guest profile'],
    neverOwns: ['PHI', 'GFE payload', 'clinical notes', 'treatment eligibility'],
    inboundEvents: ['contact.updated'],
    outboundCommands: ['upsert contact', 'update hospitality properties'],
    idempotencyKey: 'contact_email',
    ...
    phiPolicy: 'CRM-safe fields only: identifiers + lifecycle + hospitality preferences. No clinical, no PHI.',
    localReplacementPoint: 'api/_hubspot.js and src/lib/hubspotPlaceholder.js',
