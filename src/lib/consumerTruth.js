...
export function buildConsumerTruthLayer({
  ...
  const modules = [
    ...
    module({
      ...
      nextAction: nurseAssigned ? 'Send the client route update.' : 'Offer to credential-clear nurses.',
    ...
    module({
      ...
      nextAction: nurseAssigned ? 'Publish the route update.' : 'Continue Y/N offer loop.',
    ...
    module({
      ...
      owner: 'Field RN',
      detail: nurseAssigned ? 'The route unlocks after acceptance.' : 'Route details stay hidden until a real nurse accepts.',
    ...
    module({
      ...
      owner: 'Care team',
      detail: latestOpsMessage?.text || 'SMS placeholders are queued for GFE, nurse accepted, route updates, and follow-up.',
