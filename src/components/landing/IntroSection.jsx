        ...
        >
          ...
          <div className="relative group">
            ...
            <div className="overflow-x-auto mx-auto max-w-full" style={{ scrollbarWidth: 'none', msOverflowStyle: 'none' }}>
              <div ref={scrollRef} className="inline-grid gap-3 md:gap-4" style={{ gridAutoRows: 'minmax(140px, 1fr)', gridTemplateColumns: 'repeat(3, minmax(160px, 1fr))', gridAutoFlow: 'column', width: 'fit-content' }}>
