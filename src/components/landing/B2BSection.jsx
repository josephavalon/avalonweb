        ...
        <div className="grid md:grid-cols-2 gap-16 items-center">
          ...
          >
            <p className="font-body text-sm text-foreground leading-relaxed mb-4">
              Avalon operates at the point of execution — alongside the teams actually moving people: tech orgs, touring productions, festivals, and venues. Protocols are delivered where performance happens, not after.
            </p>
            <p className="font-body text-sm text-foreground leading-relaxed mb-4">
