    ...
    <footer className="border-t border-border py-6 md:py-10 px-4">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-3 md:grid-cols-5 gap-x-3 md:gap-x-4 gap-y-6 md:gap-8 mb-6 md:mb-8">
          ...
          <div>
            <p className="text-[9px] tracking-[0.3em] text-foreground uppercase font-body mb-3 md:mb-4">Services</p>
          ...
          <div>
            <p className="text-[9px] tracking-[0.3em] text-foreground uppercase font-body mb-3 md:mb-4">Company</p>
            <div className="space-y-2 md:space-y-2.5">
          ...
          <div>
            <p className="text-[9px] tracking-[0.3em] text-foreground uppercase font-body mb-3 md:mb-4">About Us</p>
            <div className="space-y-2 md:space-y-3">
              <div className="flex items-center gap-2 md:gap-3">
                <Mail className="w-3.5 h-3.5 md:w-4 md:h-4 text-foreground shrink-0" />
                <a href="mailto:support@avalonvitality.co" className="text-[10px] md:text-xs text-foreground hover:text-foreground transition-colors font-body break-all md:break-normal">support@avalonvitality.co</a>
              </div>
              <div className="flex items-center gap-2 md:gap-3">
                <Phone className="w-3.5 h-3.5 md:w-4 md:h-4 text-foreground shrink-0" />
                <a href="tel:+14159807708" className="text-[10px] md:text-xs text-foreground hover:text-foreground transition-colors font-body">(415) 980-7708</a>
              </div>
              <div className="flex items-center gap-2 md:gap-3">
                <Clock className="w-3.5 h-3.5 md:w-4 md:h-4 text-foreground shrink-0" />
                <span className="text-[10px] md:text-xs text-foreground font-body">Mon–Sun · 8AM–8PM</span>
              </div>
              <div className="flex items-start gap-2 md:gap-3">
                <span className="text-[10px] md:text-xs text-foreground font-body">San Francisco Bay Area</span>
              </div>
