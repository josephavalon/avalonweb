      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid md:grid-cols-3 gap-4 md:gap-6 items-start">
          ...
          <motion.div
            ...
            className="border border-white/20 bg-white/[0.04] backdrop-blur-md rounded-3xl p-6 md:p-8 flex flex-col"
          >
            ...
            {PILLARS.map((pillar, i) => {
              ...
              return (
                <motion.div
                  ...
                  className="border border-white/20 bg-white/[0.03] backdrop-blur-md rounded-3xl p-5 md:p-6 flex gap-4 items-start"
                >
                  <PillarIcon
