...
export default function StickyBookBar() {
  ...
  return (
    ...
    >
      <div className="relative isolate mx-2 mb-1 rounded-[18px]">
        <motion.div className="relative z-0" whileTap={premiumTap}>
          <Link
            to={BOOK_URL}
            className="av-glass-widget group flex min-h-[52px] w-full items-center justify-center gap-2 rounded-[15px] border px-16 py-2 font-body text-[11px] font-black uppercase tracking-[0.16em] text-foreground/66 transition-colors duration-base ease-editorial hover:text-foreground"
          >
            Book
