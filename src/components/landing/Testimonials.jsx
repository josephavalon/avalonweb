...
const testimonials = [
  {
    quote: "I'm a founder who codes 20 hours a day now. NAD+ makes it happen, CBD helps me relax at night.",
    name: "J.G.",
    tag: "NAD+ IV"
  },
  {
    ...
    <section className="py-8 md:py-6 px-4 border-t border-border">
      ...
      >
        ...
        <motion.p 
          ...
          className="font-body text-xs text-muted-foreground tracking-widest uppercase mt-3"
        >
          From our clients
        </motion.p>
      </motion.div>
      ...
      <div className="overflow-x-auto relative group">
        ...
        <div
          ref={scrollRef}
          className="flex gap-6 pb-2 px-16 md:px-4 items-center justify-start w-full"
