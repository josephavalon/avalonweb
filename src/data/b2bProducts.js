...
export const B2B_PRODUCTS = [
  // Singles
  {
    ...
    description: 'Avalon’s Bay-to-Breakers IV. 1L hydration with electrolytes, B-complex, glutathione. Delivered at the finish line.',
    price: 120,
    kind: 'single',
  ...
  },
  {
    ...
    description: 'Quick intramuscular B12 + lipo shot at the finish line. Five minutes, no IV. Recovery in a hurry.',
    price: 40,
    kind: 'single',
