...
export const B2B_PRODUCTS = [
  ...
  },
  {
    ...
    description: 'Sodium, potassium, calcium chloride, lactate, B-12, B-complex, and magnesium. Lactated Ringer\'s base. Delivered at the finish line.',
    price: 120,
    originalPrice: 400,
    kind: 'single',
    consumes: ['b2bIv'],
    flair: { line1: '70% OFF', line2: 'ONE DAY ONLY' },
