export const IV_ADDONS = [
  ...
  { label: 'NAD+ (500mg)', price: 500, desc: 'NAD+ add-on · 1-4 hr infusion', img: '/addons/nad-iv.png', group: 'nad' },
  { label: 'NAD+ (750mg)', price: 650, desc: 'NAD+ add-on · 1-4 hr infusion', img: '/addons/nad-iv.png', group: 'nad' },
  { label: 'NAD+ (1000mg)', price: 800, desc: 'NAD+ add-on · 1-4 hr infusion', img: '/addons/nad-iv.png', group: 'nad' },
  { label: 'NAD+ (1250mg)', price: 1000, desc: 'NAD+ add-on · 1-4 hr infusion', img: '/addons/nad-iv.png', group: 'nad' },
  { label: 'NAD+ (1500mg)', price: 1200, desc: 'NAD+ add-on · 1-4 hr infusion', img: '/addons/nad-iv.png', group: 'nad' },
