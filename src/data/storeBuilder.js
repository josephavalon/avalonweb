...
export const BASE_CATEGORIES = [
  ...
  },
  {
    id: 'everything',
    name: 'Everything',
    description: 'Every IV med + every add-on. The Works.',
...
export const ADD_ONS = [
  ...
  { id: 'extra-gluta-200',  name: 'Glutathione 200 mg',       price: 40, sub: 'Light push. Standard antioxidant boost.',     group: 'Glutathione',   compatibleBaseCategories: ['iv-vitamins', 'iv-nad', 'iv-cbd'] },
  { id: 'extra-gluta-400',  name: 'Glutathione 400 mg',       price: 70, sub: 'Mid push. The most common request.',           group: 'Glutathione',   compatibleBaseCategories: ['iv-vitamins', 'iv-nad', 'iv-cbd'] },
  { id: 'extra-gluta-600',  name: 'Glutathione 600 mg',       price: 95, sub: 'Higher therapeutic dose.',                      group: 'Glutathione',   compatibleBaseCategories: ['iv-vitamins', 'iv-nad', 'iv-cbd'] },
  { id: 'extra-gluta-1000', name: 'Glutathione 1000 mg',      price: 145, sub: 'High-dose push. Master antioxidant flood.',     group: 'Glutathione',   compatibleBaseCategories: ['iv-vitamins', 'iv-nad', 'iv-cbd'] },
