...
export const STAFF = [
  { id: 's1', first_name: 'Avery',     last_name: 'Stone',    role: 'admin',      email: 'admin.preview@avalon.local', phone: '(415) 555-0101', is_active: true,  last_login: '2026-05-11T08:14:00Z', created_at: '2025-09-01T00:00:00Z' },
  { id: 's2', first_name: 'Rowan',     last_name: 'Vale',     role: 'nurse',      email: 'nurse.one@avalon.local',     phone: '(415) 555-0102', is_active: true,  last_login: '2026-05-10T17:42:00Z', created_at: '2025-10-12T00:00:00Z' },
  { id: 's3', first_name: 'Kai',       last_name: 'Mercer',   role: 'nurse',      email: 'nurse.two@avalon.local',     phone: '(415) 555-0103', is_active: true,  last_login: '2026-05-09T09:05:00Z', created_at: '2025-11-03T00:00:00Z' },
  { id: 's4', first_name: 'Mira',      last_name: 'Shah',     role: 'nurse',      email: 'nurse.three@avalon.local',   phone: '(415) 555-0104', is_active: false, last_login: '2026-03-22T11:00:00Z', created_at: '2026-01-15T00:00:00Z' },
];
...
export const SERVICES = [
  ...
  { id: 'sv2', name: 'NAD+ Infusion',        category: 'iv_therapy',  base_price: 280, duration_minutes: 90,  is_active: true,  description: 'Clinician-reviewed NAD+ IV infusion.' },
  { id: 'sv3', name: 'CBD Review',           category: 'iv_therapy',  base_price: 200, duration_minutes: 60,  is_active: false, description: 'Approval-gated CBD category pending clinical and legal review.' },
  { id: 'sv4', name: 'Hydration Boost',      category: 'iv_therapy',  base_price: 149, duration_minutes: 45,  is_active: true,  description: 'Isotonic saline + electrolytes for hydration support.' },
  ...
  { id: 'sv6', name: 'Glutathione Push',     category: 'injection',   base_price: 75,  duration_minutes: 15,  is_active: true,  description: 'IV push add-on for antioxidant support.' },
  ...
  { id: 'sv10',name: 'Longevity Support Drip', category: 'iv_therapy', base_price: 300, duration_minutes: 75,  is_active: false, description: 'Deprecated - replaced by VIP Recovery Package.' },
];

export const CLIENTS = [
  { id: 'c1',  first_name: 'Alex',     last_name: 'Chen',      email: 'alex.chen@example.com',         phone: '(415) 555-1001', city: 'San Francisco', zip: '94105', tags: ['vip', 'recurring'],      intake_completed: true,  is_active: true,  source: 'website',  total_spent: 1840, visit_count: 9,  last_visit: '2026-05-08', created_at: '2025-10-05' },
  { id: 'c2',  first_name: 'Maya',     last_name: 'Patel',     email: 'maya.patel@example.com',        phone: '(415) 555-1002', city: 'San Francisco', zip: '94110', tags: ['recurring'],             intake_completed: true,  is_active: true,  source: 'referral', total_spent: 940,  visit_count: 4,  last_visit: '2026-04-28', created_at: '2025-11-12' },
  { id: 'c3',  first_name: 'Tyler',    last_name: 'Brooks',    email: 'tyler.brooks@example.com',      phone: '(415) 555-1003', city: 'Palo Alto',     zip: '94301', tags: ['corporate'],             intake_completed: true,  is_active: true,  source: 'corporate',total_spent: 2200, visit_count: 11, last_visit: '2026-05-02', created_at: '2025-09-20' },
  { id: 'c4',  first_name: 'Sienna',   last_name: 'West',      email: 'sienna.west@example.com',      phone: '(415) 555-1004', city: 'Marin',         zip: '94941', tags: ['vip'],                   intake_completed: true,  is_active: true,  source: 'yelp',     total_spent: 3600, visit_count: 18, last_visit: '2026-05-10', created_at: '2025-08-15' },
  { id: 'c5',  first_name: 'James',    last_name: 'Okafor',    email: 'james.okafor@example.com',      phone: '(415) 555-1005', city: 'Oakland',       zip: '94612', tags: ['athlete'],               intake_completed: true,  is_active: true,  source: 'instagram',total_spent: 760,  visit_count: 3,  last_visit: '2026-04-15', created_at: '2026-01-08' },
  { id: 'c6',  first_name: 'Rachel',   last_name: 'Kim',       email: 'rachel.kim@example.com',        phone: '(415) 555-1006', city: 'San Francisco', zip: '94114', tags: ['recurring'],             intake_completed: true,  is_active: true,  source: 'referral', total_spent: 1200, visit_count: 6,  last_visit: '2026-05-05', created_at: '2025-12-01' },
  ...
  { id: 'c8',  first_name: 'Priya',    last_name: 'Sharma',    email: 'priya.sharma@example.com',      phone: '(415) 555-1008', city: 'Sunnyvale',     zip: '94086', tags: [],                        intake_completed: false, is_active: true,  source: 'google',   total_spent: 200,  visit_count: 1,  last_visit: '2026-05-11', created_at: '2026-05-11' },
  { id: 'c9',  first_name: 'Marcus',   last_name: 'Lee',       email: 'marcus.lee@example.com',        phone: '(415) 555-1009', city: 'Berkeley',      zip: '94710', tags: ['athlete'],               intake_completed: true,  is_active: true,  source: 'referral', total_spent: 920,  visit_count: 4,  last_visit: '2026-03-18', created_at: '2026-01-25' },
  { id: 'c10', first_name: 'Sofia',    last_name: 'Reyes',     email: 'sofia.reyes@example.com',       phone: '(415) 555-1010', city: 'San Francisco', zip: '94103', tags: ['vip', 'recurring'],      intake_completed: true,  is_active: true,  source: 'instagram',total_spent: 2800, visit_count: 14, last_visit: '2026-05-09', created_at: '2025-09-01' },
  { id: 'c11', first_name: 'Noah',     last_name: 'Green',     email: 'noah.green@example.com',        phone: '(415) 555-1011', city: 'San Francisco', zip: '94117', tags: [],                        intake_completed: true,  is_active: true,  source: 'website',  total_spent: 400,  visit_count: 2,  last_visit: '2026-02-12', created_at: '2026-02-01' },
  { id: 'c12', first_name: 'Amanda',   last_name: 'Torres',    email: 'amanda.torres@example.com',     phone: '(415) 555-1012', city: 'Marin',         zip: '94930', tags: ['recurring'],             intake_completed: true,  is_active: false, source: 'yelp',     total_spent: 580,  visit_count: 3,  last_visit: '2026-01-22', created_at: '2025-11-08' },
];
...
export const APPOINTMENTS = [
  ...
  // Completed
  { id: 'a7',  client_id: 'c4',  nurse_id: 's2', service_id: 'sv1', scheduled_at: '2026-05-10T11:00:00', status: 'completed',   location_address: '155 Steuart St', location_city: 'San Francisco', location_notes: 'Four Seasons, Suite 1104', clinical_notes: '', created_at: '2026-05-08' },
  { id: 'a8',  client_id: 'c1',  nurse_id: 's3', service_id: 'sv2', scheduled_at: '2026-05-08T13:30:00', status: 'completed',   location_address: '188 King St',    location_city: 'San Francisco', location_notes: 'Apt 2205', clinical_notes: '', created_at: '2026-05-07' },
  { id: 'a9',  client_id: 'c2',  nurse_id: 's2', service_id: 'sv1', scheduled_at: '2026-05-08T10:00:00', status: 'completed',   location_address: '3388 22nd St',   location_city: 'San Francisco', location_notes: '', clinical_notes: '', created_at: '2026-05-06' },
  { id: 'a10', client_id: 'c10', nurse_id: 's3', service_id: 'sv9', scheduled_at: '2026-05-07T14:00:00', status: 'completed',   location_address: '500 Florida St', location_city: 'San Francisco', location_notes: '', clinical_notes: '', created_at: '2026-05-05' },
  { id: 'a11', client_id: 'c3',  nurse_id: 's2', service_id: 'sv5', scheduled_at: '2026-05-06T09:00:00', status: 'completed',   location_address: '3000 El Camino', location_city: 'Palo Alto',     location_notes: 'Office visit', clinical_notes: '', created_at: '2026-05-04' },
