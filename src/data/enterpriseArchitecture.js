...
export const ENTERPRISE_MARKETPLACE_SIDES = [
  ...
  },
  {
    ...
    owns: ['Shift acceptance', 'Route status', 'Route packet', 'Credential readiness', 'Kit inventory', 'Closeout proof'],
  },
  {
    id: 'core',
...
export const ENTERPRISE_DOMAIN_SERVICES = [
  ...
  },
  {
    ...
    status: 'modeled',
    buildNow: ['Real status timeline', 'Route status display', 'Prep checklist', 'Care thread'],
    laterApi: ['SMS delivery', 'Email delivery', 'Payment receipts'],
    events: ['client.status_viewed', 'client.message_sent', 'route.status_changed', 'aftercare.sent'],
  ...
  },
  {
    ...
    status: 'modeled',
    buildNow: ['Shift claim', 'Route handoff', 'Route packet', 'Bring-list', 'Thin closeout', 'Training review'],
    laterApi: ['Live SMS reply', 'Acuity writeback', 'Maps routing', 'Credential verification'],
    events: ['shift.claimed', 'route.status_changed', 'visit.started', 'visit.closed'],
  ...
  },
  {
    ...
    events: ['geo.provider_ping', 'geo.zone_scored', 'route.status_changed', 'coverage.gap_detected'],
