...
export const IV_ADDONS = [
  ...
  { label: 'NAD+ (750mg)', price: 650, desc: 'Clinician-reviewed NAD+ add-on · 1-4 hr infusion', group: 'nad' },
  { label: 'NAD+ (1000mg)', price: 800, desc: 'Clinician-reviewed NAD+ add-on · 1-4 hr infusion', group: 'nad' },
  { label: 'NAD+ (1250mg)', price: 1000, desc: 'Clinician-reviewed NAD+ add-on · 1-4 hr infusion', group: 'nad' },
  { label: 'NAD+ (1500mg)', price: 1200, desc: 'Clinician-reviewed NAD+ add-on · 1-4 hr infusion', group: 'nad' },
