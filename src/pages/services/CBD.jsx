...
const treatments = [
  { name: 'CBD 33mg', price: '$250', desc: 'Entry dose for mild anti-inflammatory support, stress relief, and relaxation. Zero THC.', image: 'https://images.unsplash.com/photo-1576091160550-112173f7f869?w=600&q=80' },
  { name: 'CBD 66mg', price: '$300', desc: 'Mid-range dose for anxiety relief, post-workout recovery, and sleep support.', image: 'https://images.unsplash.com/photo-1576091160550-112173f7f869?w=600&q=80' },
  { name: 'CBD 99mg', price: '$350', desc: 'Higher dose for chronic inflammation, deeper relaxation, and enhanced recovery.', image: 'https://images.unsplash.com/photo-1576091160550-112173f7f869?w=600&q=80' },
...
export default function CBD() {
  return (
    <ServicePageLayout
      ...
      heroImage="https://images.unsplash.com/photo-1587854692152-cbe660dbde0e?w=1200&q=85&fm=webp"
    />
  );
}