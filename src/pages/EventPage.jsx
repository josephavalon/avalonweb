            ...
            <div>
              <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8, ease: EASE }} className="relative aspect-[4/3] rounded-3xl overflow-hidden border border-border mb-8 bg-card">
                ...
                <div className="absolute bottom-6 left-6 right-6">
                  <p className="text-[10px] tracking-[0.35em] text-accent font-body uppercase mb-2">{event.date}</p>
              ...
              <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8, delay: 0.1, ease: EASE }}>
                <p className="font-body text-[10px] tracking-[0.35em] text-accent uppercase mb-3">About this event</p>
              ...
              <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8, delay: 0.15, ease: EASE }} className="mt-10 pt-8 border-t border-border">
                <p className="font-body text-[10px] tracking-[0.35em] text-accent uppercase mb-5">Hosted by</p>
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <p className="font-body text-[10px] tracking-[0.25em] text-muted-foreground uppercase mt-0.5">{event.hostRole || 'Host'}</p>
                  </div>
                </div>
              </motion.div>
            </div>
              ...
              <div className="border border-border rounded-3xl bg-card p-6 md:p-7">
                <div className="space-y-5 mb-6">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      <p className="font-body text-[9px] tracking-[0.3em] text-muted-foreground uppercase mb-1">When</p>
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      <p className="font-body text-[9px] tracking-[0.3em] text-muted-foreground uppercase mb-1">Where</p>
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      <p className="font-body text-[9px] tracking-[0.3em] text-muted-foreground uppercase mb-1">Capacity</p>
