      ...
      <section className="pt-28 md:pt-36 pb-12 md:pb-20 px-6 md:px-16">
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid md:grid-cols-[1fr_360px] gap-8 md:gap-12">
            ...
            <div>
              <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8, ease: EASE }} className="relative aspect-[4/3] rounded-3xl overflow-hidden border border-white/15 bg-white/[0.03] backdrop-blur-md mb-8">
              ...
              <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8, delay: 0.15, ease: EASE }} className="mt-10 pt-8 border-t border-border">
                ...
                <div className="flex items-center gap-4">
                  <div className="w-12 h-12 rounded-full border border-white/15 bg-white/[0.05] backdrop-blur-md flex items-center justify-center">
            ...
            <motion.aside initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8, delay: 0.2, ease: EASE }} className="md:sticky md:top-28 self-start">
              <div className="border border-white/15 bg-white/[0.04] backdrop-blur-md rounded-3xl p-5 md:p-6">
